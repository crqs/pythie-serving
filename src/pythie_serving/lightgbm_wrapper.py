        ...
        for feature_name in features_names:
            ...
            for sample_index, value in enumerate(nd_array):
                sample_feature_value = (
                    feature_categories.index(value[0].decode("utf-8"))
                    if is_pd_categorical
                    else value[0]
                )
                samples[sample_index].append(sample_feature_value)
